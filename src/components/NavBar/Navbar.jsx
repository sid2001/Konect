...
import { logOut } from '../../utils/getUser';
  ...
  return(
    <div id={isForm?'navbar-isForm':'navbar'}>
      ...
      <div id='nav-right'>
        ...
        {userContext.user.isLoggedIn===false?<NavLink to={'/form?type=login'}><img className='nav-icon' src={loginIcon} alt="li" /></NavLink>:<NavLink><img onClick={logOutHandler} className='nav-icon' src={logoutIcon} alt="li" /></NavLink>}
